...
void Vf1_fsm_1s___024root__trace_chg_sub_0(Vf1_fsm_1s___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vf1_fsm_1s___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_fsm_1s___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vf1_fsm_1s___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vf1_fsm_1s___024root__trace_chg_sub_0(Vf1_fsm_1s___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_fsm_1s__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_fsm_1s___024root__trace_chg_sub_0\n"); );
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode + 1);
    // Body
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgBit(oldp+0,(vlSelf->f1_fsm_1s__DOT__tick));
        bufp->chgCData(oldp+1,(vlSelf->f1_fsm_1s__DOT__myClktick__DOT__count),6);
        bufp->chgIData(oldp+2,(vlSelf->f1_fsm_1s__DOT__myF1_fsm__DOT__current_state),32);
        bufp->chgIData(oldp+3,((((((((((0U == vlSelf->f1_fsm_1s__DOT__myF1_fsm__DOT__current_state) 
...
void Vf1_fsm_1s___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_fsm_1s___024root__trace_cleanup\n"); );
    // Init
    Vf1_fsm_1s___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vf1_fsm_1s___024root*>(voidSelf);
    Vf1_fsm_1s__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
