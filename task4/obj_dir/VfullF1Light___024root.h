...
class VfullF1Light___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ fullF1Light__DOT__en;
    CData/*0:0*/ fullF1Light__DOT__tick;
    CData/*5:0*/ fullF1Light__DOT__myClktick__DOT__count;
    CData/*6:0*/ fullF1Light__DOT__my_lfsr__DOT__sreg;
    CData/*6:0*/ fullF1Light__DOT__my_delay__DOT__count;
    CData/*6:0*/ __Vdly__fullF1Light__DOT__my_lfsr__DOT__sreg;
    ...
    IData/*31:0*/ fullF1Light__DOT__my_delay__DOT__current_state;
    IData/*31:0*/ fullF1Light__DOT__my_delay__DOT__next_state;
