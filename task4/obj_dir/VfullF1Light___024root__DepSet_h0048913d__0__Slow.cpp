...
VL_ATTR_COLD void VfullF1Light___024root___initial__TOP__0(VfullF1Light___024root* vlSelf) {
    ...
    // Body
    vlSelf->fullF1Light__DOT__my_lfsr__DOT__sreg = 1U;
    vlSelf->fullF1Light__DOT__my_delay__DOT__count = 0U;
}
...
VL_ATTR_COLD void VfullF1Light___024root___ctor_var_reset(VfullF1Light___024root* vlSelf) {
    ...
    vlSelf->fullF1Light__DOT__en = VL_RAND_RESET_I(1);
    ...
    vlSelf->fullF1Light__DOT__my_lfsr__DOT__sreg = VL_RAND_RESET_I(7);
    vlSelf->fullF1Light__DOT__my_delay__DOT__count = VL_RAND_RESET_I(7);
    vlSelf->fullF1Light__DOT__my_delay__DOT__current_state = 0;
    vlSelf->fullF1Light__DOT__my_delay__DOT__next_state = 0;
    vlSelf->__Vdly__fullF1Light__DOT__my_lfsr__DOT__sreg = VL_RAND_RESET_I(7);
